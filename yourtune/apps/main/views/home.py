...
def home(request):
    """Главная страница с аффирмациями."""
    context = {
        "hero": {
            "badge": "Один сайт — три настроения",
            # "title": "Аффирмации на каждый день",
            'title': 'YourTune — аффирмации и ежедневные практики',
            "description": (
                # "Мягкие практики для спокойствия, уверенности "
                # "и внутренней опоры."
                'Платформа аффирмаций, тематических подборок и ежедневных практик для спокойствия, уверенности и личностного роста.'
            ),
            "primary_action": {
                "label": "Смотреть темы",
                "anchor": "#topics",
